...
<body class="page-header-fixed">
	...
	<div class="page-container row-fluid">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<!-- BEGIN 网页的标题和面包屑-->
						<h3 class="page-title">
							My desktop <small>navigation page</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
				...
				<div class="tiles">
				<div class="tile bg-yellow" url="pages_testcustomer/test_customer_cate">
						<div class="tile-body"><i class="icon-user-md"></i></div>
						<div class="tile-object">
							<div class="name">Customer category</div>
							<div class="number"></div>
						</div>
					</div>
				
				<div class="tile bg-green" url="pages_testcustomer/test_customer">
			...
			<div class="tile double bg-grey" url="index.jsp">
						<div class="tile-body">
