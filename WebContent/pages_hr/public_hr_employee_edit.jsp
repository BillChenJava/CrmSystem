					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="hr_emp!update" method="post" class="form-horizontal">
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="emp.uid" type="text" value='<s:property value="#emp.uid"/>'
										...
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="emp.pwd" disabled="disabled" type="text" value='<s:property value="#emp.pwd"/>'
													class="m-wrap span12" placeholder="必填">
												</div>
											</div>
										</div>
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="emp.name"  type="text" value='<s:property value="#emp.name"/>'
														class="m-wrap span12" placeholder="可填">
												</div>
											</div>
										</div>
												...
												<div class="controls">
													<div class="input-append date date-picker"
														...
														<input name="emp.birthday"  class="m-wrap m-ctrl-medium date-picker" size="16"
															type="text" placeholder="请选择" value="<s:date name="#emp.birthday" format="yyyy-MM-dd" />" /> <span class="add-on"><i
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="emp.idcard" type="text" value='<s:property value="#emp.idcard"/>'
														class="m-wrap span12" placeholder="可填">
												</div>
											</div>
										</div>
										<div class="span6 ">
											<div class="control-group">
												...
												<label class="radio">
													...
													class="m-wrap span12" ${emp.sex == '先生'?'checked':''}>先生
												</label>
												<label class="radio">
													<input name="emp.sex" type="radio" value="女士"
													class="m-wrap span12" ${emp.sex == '女士'?'checked':''}>女士
												</label>
												</div>
											</div>
										</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<select id="positionselect" name="emp.hrPosition.id" class="m-wrap span6">
														<option value="<s:property value="#emp.hrPosition.id"/>">原值:<s:property value="#emp.hrPosition.positionName"/></option>
													</select>
													<select id="postselect" name="emp.hrPost.postId" class="m-wrap span6">
														<option value="<s:property value="#emp.hrPost.postId"/>">原值:<s:property value="#emp.hrPost.postName"/></option>
													</select>
												</div>
											</div>
										</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<select id="select2_sample_deps" name="emp.hrDepartment.id" class="m-wrap span12">
														<option value="<s:property value="#emp.hrDepartment.id"/>">原值:<s:property value="#emp.hrDepartment.DName"/></option>
													</select>
												</div>
											</div>
										</div>
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="emp.email" value="<s:property value="#emp.email"/>" type="text" class="m-wrap span12" placeholder="必填">
												</div>
											</div>
										</div>
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="emp.telephone" value="<s:property value="#emp.telephone"/>" type="text" class="m-wrap span12" placeholder="必填">
												</div>
											</div>
										</div>
									</div>
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="emp.address" type="text" value="<s:property value="#emp.address"/>"
													class="m-wrap span12" placeholder="必填">
												</div>
											</div>
										</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<select id="" name="emp.education" class="m-wrap span12">
														<option value="<s:property value="#emp.education"/>">原值:<s:property value="#emp.education"/></option>
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="emp.professional" type="text" value="<s:property value="#emp.professional"/>"
													class="m-wrap span12" placeholder="必填">
												</div>
											</div>
										</div>
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="emp.schools" type="text" value="<s:property value="#emp.schools"/>"
													class="m-wrap span12" placeholder="必填">
												</div>
											</div>
										</div>
												...
												<div class="controls">
													<div class="input-append date date-picker"
														...
														<input name="emp.entrydate"  class="m-wrap m-ctrl-medium date-picker" size="16"
															type="text" placeholder="请选择" value="<s:date name="#emp.entrydate" format="yyyy-MM-dd" />" /> <span class="add-on"><i
															class="icon-calendar"></i> </span>
													</div>
												</div>
											</div>
										...
										<div class="span6 ">
											<div class="control-group">
												...
												<label class="radio">
													...
													class="m-wrap span12" ${emp.canlogin eq 1?'checked':''}>是
												</label>
												<label class="radio">
													<input name="emp.canlogin" type="radio" value="0"
													class="m-wrap span12" ${emp.canlogin eq 0?'checked':''}>否
												</label>
												</div>
											</div>
										</div>
										...
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													...
													class="m-wrap span12" ${emp.ispost eq 1?'checked':''}>在职
												</label>
												<label class="radio">
													<input name="emp.ispost" type="radio" value="0"
													class="m-wrap span12" ${emp.ispost eq 0?'checked':''}>离职
												</label>
												</div>
											</div>
										</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<select id="roleselect" name="emp.sysRole.roleid" class="m-wrap span12">
														<option value="<s:property value="#emp.sysRole.roleid"/>"><s:property value="#emp.sysRole.rolename"/></option>
													</select>
												</div>
											</div>
										</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<select id="emplevel" name="emp.paramSysparam.id" class="m-wrap span12">
														<option value="<s:property value="#emp.paramSysparam.id"/>"><s:property value="#emp.paramSysparam.paramsName"/></option>
													</select>
												</div>
											</div>
										</div>
									...
									<div class="row-fluid">
										<div class="span12 ">
											<div class="control-group">
												...
												<div class="controls">
													<textarea rows="3" cols="" name="emp.remarks" class="span12 m-wrap"><s:property value="#emp.remarks"/></textarea>
												</div>
											</div>
										</div>
									</div>
