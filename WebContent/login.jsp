...
<body class="login">
	<!-- BEGIN LOGO -->
	<div class="logo"><img src="<%=basePath%>media/image/CRM.png"> </div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		<!-- begin Login box -->
		...
		<div id="myModal2" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
			...
			<div class="modal-footer">
				<button data-dismiss="modal" class="btn green">Cancel</button>
			</div>
		</div>
		<!-- end login box -->
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="hr_emp!login" method="post" >
			<h3 class="form-title" style="text-align: center;">CRM System</h3>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="username" name="name" value="admin"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix" type="password" placeholder="password" name="pwd" value="123456"/>
					</div>
				</div>
			</div>
			<!-- 
	...
	<!-- END LOGIN -->
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">2019 &copy; 【Bin Chen】 - CRM System</div>
	<!-- END COPYRIGHT -->
